...
![ComplaintType20182019](311_Service_Request_Analysis/results/Analysis/Q1/ReportImages/Overall.png)
...
![BoroughWiseComplaintType20182019](311_Service_Request_Analysis/results/Analysis/Q1/ReportImages/Borough_Grouped.png)
...
![NoiseHourly20182019](311_Service_Request_Analysis/results/Analysis/Q2/ReportImages/NoiseHourly2018_2019.png) 
...
![ParkingDaily20182019](311_Service_Request_Analysis/results/Analysis/Q2/ReportImages/VehicleDaily2018_2019.png)
...
![NoiseMonthly2018](311_Service_Request_Analysis/results/Analysis/Q2/ReportImages/NoiseMonthly2018_2019.png)
...
* On the basis of Complaint Type
	...
	![AverageTimeToResolveIssue](311_Service_Request_Analysis/results/Analysis/Q3/ReportImages/Overall.png)
...
![AgencyWiseComplaintTypeResolutionTime](311_Service_Request_Analysis/results/Analysis/Q3/ReportImages/Agency.png)
...
**2 Clusters upto 20 Clusters** and tried plotting an Elbow curve shown in the figure below. The **cost(J)** in the plot represents - **Inertia** which is the sum of squared distances of samples to their closest cluster center.
	...
	![CostKMeansElbow](311_Service_Request_Analysis/results/Analysis/Clustering/ReportImages/ClusteringCostAndElbow.JPG)
	...
	[CluteringResults2019](311_Service_Request_Analysis/results/Analysis/Clustering/Reference_2019/ClusteringResults.txt)
	...
	![ClusterAnalysis](311_Service_Request_Analysis/results/Analysis/Clustering/ReportImages/Analysis_Cluster_2.png)
...
3. **Supervised Learning: Mostly used python package - pyspark.ml** 
	...
	* RMSE(Root Mean Squared) - Lesser the RMSE of a model the better it is. It provides a quantifiable error figure of the same unit as that of the target variable.
	![EvaluationMetricRMSE](311_Service_Request_Analysis/results/Analysis/Supervised%20Learning/ReportImages/RMSE.JPG)
	...
	* R-Squared - scale free(unit independent) unlike RMSE (Range -infinity to 1); R-squared value .5 means model captures 50% variance of the target variable however a negative value indicates a poorly fit model. 
	![EvaluationMetricRSquare](311_Service_Request_Analysis/results/Analysis/Supervised%20Learning/ReportImages/R2.JPG)
